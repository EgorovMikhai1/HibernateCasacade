package com.example.hibernatecasacde.aspect;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(public * com.example.hibernatecasacde.controller.*.*(..))")
    public void controllerLog() {
    }

    @Pointcut("execution(public * com.example.hibernatecasacde.service.*.*(..))")
